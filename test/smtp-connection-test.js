...
describe('Login tests', function () {
  ...
  var server, lmtpServer, client, lmtpClient
  ...
  describe('Send messages', function () {
    ...
    it('should send message buffer', function (done) {
      var chunks = []
      var message = new Buffer(new Array(1024).join('teretere, vana kere\n'))
    ...
    it('should send message stream', function (done) {
      var chunks = []
      var fname = path.join(__dirname, '../LICENSE')
      var message = fs.readFileSync(fname, 'utf-8')
